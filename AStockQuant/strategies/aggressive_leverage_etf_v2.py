# -*- coding: utf-8 -*-
"""
Aggressive Leverage ETF Strategy (Optimized)
Target: 100%+ annual return, 30%+ monthly return
Features:
- Daily rebalancing, only hold top 3 strongest ETFs
- 2.5x margin leverage
- 4% take profit, 1.5% stop loss
...
def backtest(start_date="2024-01-01", end_date="2026-03-31", initial_capital=1000000):
    ...
    output_path = REPORT_DIR / "aggressive_leverage_results_v2.json"
    with open(output_path, "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=2)
    
    print("=== Aggressive Leverage ETF Strategy V2 Results ===")
